        ...
        <tr class="hover:bg-grey-lighter">
          ...
          <td class="py-4 px-6 border-b border-grey-light"> 
           <form action="{{ route('Student.destroy',$student->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <a href="{{ route('SubjectChoice.show',$student->id) }}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-yellow-400 hover:bg-green-dark">Add Subject</a><br>
