        ...
        <div class="grid lg:grid-cols-2 gap-6">
            <div
                ...
                <form action="{{ route('Student.store') }}" method="POST">
                    ...
                    <p>
                        <input name="fname" autocomplete="false" tabindex="0" type="text"
                            class="py-1 px-1 text-gray-900 outline-none block h-full w-full" value="{{ old('fname') }}"
                            required>
                    </p>
            </div>
            <div
                ...
                <p>
                    <input name="lname" autocomplete="false" tabindex="0" type="text"
                        class="py-1 px-1 outline-none block h-full w-full" value="{{ old('lname') }}" required>
                </p>
            </div>
            <div
                class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
            ...
            <div
                ...
                <p>
                    <input name="phone" autocomplete="false" tabindex="0" type="text"
                        class="py-1 px-1 outline-none block h-full w-full" value="{{ old('phone') }}" required>
                </p>
            </div>
            <div
                class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                ...
                <p>
                    <input name="class" autocomplete="false" tabindex="0" type="text"
                        class="py-1 px-1 outline-none block h-full w-full" value="{{ old('class') }}" required>
                </p>
            </div>
            <div
                class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                ...
                <p>
                    <input name="email" type="email" class="py-1 px-1 outline-none block h-full w-full" required
                        value="{{ old('email') }}">
                </p>
            ...
            <div
                ...
                <div class="-mt-4 absolute tracking-wider px-1 uppercase text-xs">
                    <p>
                        <label for="gender" class="bg-white text-gray-600 px-1">Gender</label>
                    </p>
                </div>
